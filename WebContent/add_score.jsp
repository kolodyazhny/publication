...
<head>
    ...
    <fmt:message bundle="${loc}" key="score.header" var="scoreHeader"/>
    <fmt:message bundle="${loc}" key="score.get" var="scoreGet"/>
...
<div class="container">
    ...
    <div class="row">
        <h3>${cardHeader}.</h3>
        <br>
        <form class="form-horizontal" role="form" action="NewScore" method="post">

            <input type="hidden" name="perID" value="${requestScope.perID}">

            <div class="form-group">
                <label class="control-label col-sm-2" for="number">${cardNumber}:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-info">${scoreGet}</button>
                </div>
            </div>
        </form>
    </div>
